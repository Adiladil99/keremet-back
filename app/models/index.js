...
db.client_favourites = require("./client_favourites.model.js")(sequelize, Sequelize, db.master, db.client);
...
db.master_comments = require("./master_comments.model.js")(sequelize, Sequelize, db.master, db.client, db.service);
...
db.category.hasMany(db.sub_category, { as: 'subcategories', foreignKey: 'category_id' });
...
db.service.belongsTo(db.sub_category, { as: 'subcategory', foreignKey: 'subcategory_id' });
db.service.hasMany(db.master_services, { as: 'masters', foreignKey: 'service_id' });
db.service.hasMany(db.master_comments, { as: 'service', foreignKey: 'service_id' });
...
db.master_comments.belongsTo(db.service, { foreignKey: 'service_id', as: 'service' })
db.master_comments.belongsTo(db.master, { foreignKey: 'master_id', as: 'master' })
db.master_comments.belongsTo(db.client, { foreignKey: 'client_id', as: 'client' })


db.client_favourites.belongsTo(db.master, { foreignKey: 'master_id', as: 'master' })
db.client_favourites.belongsTo(db.client, { foreignKey: 'client_id', as: 'client' })
